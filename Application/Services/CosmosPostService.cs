...
namespace Application.Services
{
    public class CosmosPostService : ICosmosPostService
    {
        ...
        public async Task<IEnumerable<CosmosPostDto>> GetAllPostsAsync(string title)
        {
        ...
        public async Task UpdatePostAsync(UpdateCosmosPostDto updatePost)
        {
            ...
            CosmosPost post = _mapper.Map<UpdateCosmosPostDto, CosmosPost>(updatePost, existingPost);
